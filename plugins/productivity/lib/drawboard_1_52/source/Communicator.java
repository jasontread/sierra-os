...
public class Communicator extends Thread {
  ...
  // =============================================================================
  // Constructor
  public Communicator(Board b, URL u, Menu m, int p, String _host, Main par) {
    parent=par;
    table=b;
    menu=m;
    if ( _host == null)
  ...
  synchronized void connect(){
    ...
    while ((oos==null || ois==null) && !communicatorclosing){
      ...
      try{
        ...
        table.setCursorAndSentence(false, "Applet 'host' option used without digitally signed JAR archive");
        System.out.println(Lang.get("Security Exception raised!"));
      }
      try{
