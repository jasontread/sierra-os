...
public class Main extends Applet implements Runnable{
  ...
  private String HOST = null;                  // Port number
  int ID=0;
...
// =============================================================================
  public void init(){
    ...
    // Communicator
    comm=new Communicator(board, getCodeBase(), menu, PORT, HOST, this);
  ...
  void readParameters(){
    ...
    try{
      if (getParameter("host")!=null){
        ...
        System.out.println("Non-default hostname defined: "+HOST);
      }
    }catch(Exception e){
      HOST = null;
      System.out.println(Lang.get("Wrong hostname, reverting to default "));
    }
